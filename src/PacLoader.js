...
const PacLoader = ({ r, g, b }) => (
    <LoaderStyled xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" className="lds-pacman" background="none">
